...
const BATTLE_CRUISER_DATA: SuperCapData[] = [
    ...
    },
    {
        ...
        modules: {
            ...
            b1: { id: "b1", isBase: true, name: "主動防空系统", shortName: "防空导弹" },
            b2: { id: "b2", isBase: false, name: "未知", shortName: "未知模组" },
            c1: { id: "c1", isBase: false, name: "未知", shortName: "未知模组" },
            c2: { id: "c2", isBase: false, name: "未知", shortName: "未知模组" },
            d1: { id: "d1", isBase: false, name: "未知", shortName: "未知模组" },
            d2: { id: "d2", isBase: false, name: "未知", shortName: "未知模组" },
            e1: { id: "e1", isBase: false, name: "精确投射武器系統", shortName: "投射导弹" },
            e2: { id: "e2", isBase: false, name: "大型投射武器系統", shortName: "投射鱼雷" },
            f1: { id: "f1", isBase: false, name: "多目标防空系統", shortName: "载机防空" },
            f2: { id: "f2", isBase: false, name: "未知", shortName: "未知模组" },
        },
    },
];
...
const CORVETTE_DATA: ShipData[] = [
    ...
    { id: "e8", name: "CV-M011", type: ShipTypes.corvette, pop: 2, limit: 10, variants: ["导弹型", "火炮型"] },
