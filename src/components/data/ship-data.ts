...
export const CRUISER_DATA: ShipData[] = [
    ...
    { id: "c6", name: "康納馬拉混沌", type: "巡洋舰", variants: ["轨道炮", "电浆型"] },
...
export const CORVETTE_DATA: ShipData[] = [
    ...
    { id: "e2", name: "CV-T800", type: "护航艇", variants: [""] },
    { id: "e2", name: "蜂巢守卫者", type: "护航艇", variants: [""] },
    { id: "e2", name: "S-列维9号", type: "护航艇", variants: [""] },
    { id: "e2", name: "虚灵", type: "护航艇", variants: [""] },
    { id: "e2", name: "RB7-13", type: "护航艇", variants: [""] },
    { id: "e2", name: "鳐", type: "护航艇", variants: [""] },
    { id: "e2", name: "CV-M011", type: "护航艇", variants: ["导弹型", "火炮型"] },
    { id: "e2", name: "CV-II003", type: "护航艇", variants: [""] },
];
